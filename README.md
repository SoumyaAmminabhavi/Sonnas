...
│   ├── models/                                    # Flutter shared data models
│   ├── services/                                  # Flutter services (Supabase service, local auth, etc.)
│   └── customer/, owner/, staff/, widgets/        # Flutter portal screens and modular UI
│
