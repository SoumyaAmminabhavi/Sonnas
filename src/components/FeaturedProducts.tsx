            ...
            cakes?.map((cake) => (
              ...
              >
                ...
                <div className="p-lg flex flex-col items-center">
                      ...
                      <div className="flex flex-col gap-sm mb-md">
                        {cake.options.map((opt, i) => (
                          <div key={i} className="flex justify-between items-center text-sm font-body">
                            ...
                            <span className="text-rose font-medium text-lg">{formatPrice(opt.price)}</span>
                  ...
                  {whatsappNumber && (
                    <a
                      href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(`Hi! I'd like to order: ${cake.name}`)}`}
                      target="_blank"
